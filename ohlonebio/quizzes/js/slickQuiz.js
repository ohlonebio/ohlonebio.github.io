    ...
    $.slickQuiz = function(element, options) {
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                $quizHeader.hide().prepend($('<div class="quizDescription" id="hideOnStart">' +
                     quizValues.info.main
                         .replace('%total', '<span class="total">' + questionCount + '</span>') + 
                     '</div>')).fadeIn(1000, kN(key,2));
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableScore) {
                    ...
                    var percent = ((score / questionCount) * 100).toFixed();
